...
var _user$project$DiceGame$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$DiceGame$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$DiceGame$Decrement),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$DiceGame$Increment),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
if (typeof _user$project$DiceGame$main !== 'undefined') {
    _user$project$DiceGame$main(Elm['DiceGame'], 'DiceGame', undefined);
}
